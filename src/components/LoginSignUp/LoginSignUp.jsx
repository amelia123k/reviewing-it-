      ...
      <div className="auth-card">
        ...
        <div className="wave-wrapper">
          <div className="header-text">
            ...
            <p>{isLogin ? "Sign in to continue reviewing vendors" : "Create your account to get started"}</p>
          </div>
          <svg className="wave-svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
            <path d="M0,0 C150,100 350,100 600,50 C850,0 1050,0 1200,50 L1200,0 L0,0 Z" fill="url(#waveGradient)" />
            <defs>
        ...
        <div className="auth-body">
          ...
          <p className="nav" onClick={() => navigate("/signup")}>Register as Business</p>
        </div>
      </div>
    </div>
  );
